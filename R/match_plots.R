...
#' Randomization-Control plot with matching overlayed
#'
...
#' @return
#' @export
RC_match_plot <- function(data, match, title = ""){
  n_pairs <- sum(!is.na(match))/2
...
#' Randomization-Assignment plot with matching overlayed
#'
#' @inheritParams AC_match_plot
...
#' @return
#' @export
RA_match_plot <- function(data, match, title = ""){
  n_pairs <- sum(!is.na(match))/2

...
RC_match_plot <- function(data, match, k = 1, title = ""){
  n_pairs <- sum(!is.na(match))/(k + 1)
...
RA_match_plot <- function(data, match, k = 1, title = ""){
  n_pairs <- sum(!is.na(match))/(k + 1)
...
```{r}
# like a match plot but no lines; just shows included data
AC_filter_plot <- function(data, match, k = 1, title = ""){
  n_pairs <- sum(!is.na(match))/(k + 1)
